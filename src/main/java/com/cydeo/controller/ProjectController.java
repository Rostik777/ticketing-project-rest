...
public class ProjectController {
    ...
    public ResponseEntity<ResponseWrapper> updateProject(@RequestBody ProjectDTO project) {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Project is successfully updated", project, HttpStatus.CREATED));
    }
    ...
    public ResponseEntity<ResponseWrapper> deleteProject(@PathVariable("projectCode") String code) {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Project is successfully deleted", HttpStatus.CREATED));
    }
